require(["scripts/sudoku"], (sudoku) => {
	...
	module("sudoku", () => { // ---------------------------------------------------------------------
		...
		test("enumerate cells", function(assert) {
			var s, bW, bH, n;
			bW = 3; bH = 3; n = bW*bH;
			s = sudoku.create({box: [bW, bH]});
		...
		module(".parse", () => { // --------------------------------------------------
			...
			test("3x3 Klara 5coupled top-left", function(assert) {
				let t = ""
					+ "    A B C   D E F   G H I"		+ "\n"
					+ "  +-------+-------+-------+"		+ "\n"
					+ "1 | - 6 - | - - - | - 8 - | 1"	+ "\n"
			...
			test("4x4 (Elektor 558)", function(assert) {
				let t = "" 

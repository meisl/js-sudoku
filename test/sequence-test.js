require(["scripts/sequence"], function (Sequence) {
	...
	module("sequence", () => { // ------------------------------------------
		...
		module(".toString", () => { // ---------------------------------------------------
			...
			test("sequence of sequences", function (assert) {
				let s;
			...
			test("sequence of arrays", function (assert) {
				let s;
			...
			test("sequence of objects", function (assert) {
				let s;
			...
			test("sequence of array of objects", function (assert) {
				let s;
